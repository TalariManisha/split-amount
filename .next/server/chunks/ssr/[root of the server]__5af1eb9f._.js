...
async function detectKeylessEnvDrift() {
    ...
    try {
        const { safeParseClerkFile } = await __turbopack_context__.r("[project]/node_modules/@clerk/nextjs/dist/esm/server/keyless-node.js [app-rsc] (ecmascript, async loader)")(__turbopack_context__.i);
        const keylessFile = safeParseClerkFile();
        if (!keylessFile) {
            return;
        }
        const envPublishableKey = ("TURBOPACK compile-time value", "pk_test_dHJ1c3R5LXJhYmJpdC0xLmNsZXJrLmFjY291bnRzLmRldiQ");
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5af1eb9f._.js.map